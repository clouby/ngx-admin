...
import { KEY_SECRET_JWT, excluded_routes } from "../config"
...
passport.use(
    new LocalStrategy( {
        ...
        const { email, _id, nickname, fullName, role } = user

    return jwt.sign({ nickname, email, _id, fullName, role }, KEY_SECRET_JWT, { expiresIn: '10m' }, cb_jwt(done))
}))
